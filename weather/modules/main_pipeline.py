...
from daily_stats import create_daily_temperature_stats
...
class WeatherDataPipeline:
    ...
    def run(self):
        ...
        if '기온' in processed_data:
            ...
            # 5단계: 일별 최저/최고 온도 CSV 생성
            print("\n[5단계] 일별 최저/최고 온도 파일 생성...")
            daily_csv_path, daily_db_path = create_daily_temperature_stats(
                csv_path, self.processed_dir, self.db_dir, overall_start, overall_end
            )
